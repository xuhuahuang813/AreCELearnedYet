...
#!/bin/bash
# just wkld-gen-lstm census13 original lstm-1k0312_1 1000 100

# just wkld-gen-lstm census13 original lstm-5k0312_1 5000 500

# just wkld-gen-lstm census13 original lstm-1w0312_1 10000 1000



datasets=('census13')
versions=('original')
workloads=('lstm-1k0312_1')
